import { MetafoksApplicationProperties, runMetafoksApplication } from '../../context';
import { ApplicationConstructor, createAnnotation } from '../../utils';
import { merge } from '../../utils/merge';
import { DEFAULT_PROPS_FOR_ABSTRACT_APPLICATION } from '../index';

export function MetafoksTestingApplication<TConfig>(props: MetafoksApplicationProperties<TConfig> = {}) {
